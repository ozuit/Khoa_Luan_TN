...
function xmail ($to_emailaddress,$from_emailaddress, $subject, $content, $file_name, $backup_type, $ver)
{
 ...
 $mail_content="--".$boundary.NEWLINE."Content-Type: text/plain; ".NEWLINE." charset=\"iso-8859-1\"".NEWLINE."Content-Transfer-Encoding: 7bit".NEWLINE.NEWLINE."Sao lưu thành công...".NEWLINE.NEWLINE."Tập tin chứa dữ liệu sao lưu được đính kèm bên dưới; $backup_type ".NEWLINE."Nếu đây là lần sao lưu đầu tiên bạn nên thử khôi phục lại dữ liệu hệ thống bằng tập tin đính kèm để đảm bảo dữ liệu sao lưu là chính xác.".NEWLINE.NEWLINE."Đây là email được gửi tự động từ hệ thống, xin đừng trả lời phản hồi!".NEWLINE.NEWLINE."Chúc bạn một ngày tốt lành :-)".NEWLINE.$mail_attached;
