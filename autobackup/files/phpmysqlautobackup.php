...
if ($send_email_backup) xmail($to_emailaddress,$from_emailaddress, "[No-reply] Auto Backup Database", $dump_buffer, $backup_file_name, $backup_type, $phpMySQLAutoBackup_version);
