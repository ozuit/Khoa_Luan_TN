...
$db = "viettops_qlns"; // your MySQL database name
$mysql_username = "viettops_ozu";  // your MySQL username
$mysql_password = "Youtome@123";  // your MySQL password

$from_emailaddress = "no-reply@viettops.net";// your email address to show who the email is from (should be different $to_emailaddress)
$report_emailaddress = "no-reply@viettops.net";//address to send reports, not the backup just details on last backups (can be same as above)
$to_emailaddress = "viettops.net@gmail.com"; // your email address to send backup files to
